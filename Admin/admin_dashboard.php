...
<body class="flex bg-gray-100 min-h-screen">
  ...
  <!-- Sidebar -->
  <aside class="w-70 bg-gray-900 text-white min-h-screen p-8 shadow-lg flex flex-col">
  ...
  <main class="flex-1 p-10">
    <h1 class="text-3xl font-semibold text-gray-700 mb-6">Hello, <?= htmlspecialchars($_SESSION['username']) ?> 👋</h1>
  </main>
</body>
</html>
